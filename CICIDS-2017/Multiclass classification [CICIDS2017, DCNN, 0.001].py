...
np.save('/Users/ahmad/Documents/Master/results/CICIDS-2017/History/[CICIDS2017] [CNN = 0.001] Multiclass classification history.npy',history.history)
...
plt.ylim(0.993,1)
plt.savefig('/Users/ahmad/Documents/Master/results/CICIDS-2017/figuers/[CICIDS2017] [CNN = 0.001] Multiclass classification accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0,0.025)
plt.savefig('/Users/ahmad/Documents/Master/results/CICIDS-2017/figuers/[CICIDS2017] [CNN = 0.001] Multiclass classification loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
# np.save('/Users/ahmad/Documents/Master/results/CICIDS-2017/History/[CICIDS2017] [CNN = 0.001] Multiclass classification y_t.npy',y_t)
# np.save('/Users/ahmad/Documents/Master/results/CICIDS-2017/History/[CICIDS2017] [CNN = 0.001] Multiclass classification y_p_c.npy',y_p_c)
...
# ax.spines['right'].set_visible(False)
# plt.savefig('/Users/ahmad/Documents/Master/results/CICIDS-2017/figuers/[CICIDS2017] [CNN = 0.001] Multiclass classification roc.eps', format='eps', dpi=1200)
# plt.show()
# plt.clf()
...
plt.savefig('/Users/ahmad/Documents/Master/results/CICIDS-2017/figuers/[CICIDS2017] [CNN = 0.001] Multiclass classification confusion matrix.eps', bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
# plt.figure(figsize = (30,25))
# sn.set(font_scale=2.4)
...
# proposed model
mcr.to_csv(r'/Users/ahmad/Documents/Master/results/csvs/CICIDS2017] [CNN = 0.001] Multiclass classification report.csv')
scr.to_csv(r'/Users/ahmad/Documents/Master/results/csvs/[CICIDS2017] [CNN = 0.001] Summarized multiclass classification report.csv')
