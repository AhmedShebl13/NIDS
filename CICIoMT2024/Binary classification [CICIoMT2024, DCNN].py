...
np.save('D:/results/CICIoMT2024/History/[CICIoMT2024] [CNN] Binary classification history.npy',history.history)

np.save('D:/results/CICIoMT2024/history/[CICIoMT2024] [CNN] Binary classification Fitting time.npy',fitting_time_np)
...
plt.savefig('D:/results/CICIoMT2024/figures/[CICIoMT2024] [CNN] Binary classification accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0,0.0175)
plt.savefig('D:/results/CICIoMT2024/figures/[CICIoMT2024] [CNN] Binary classification loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
np.save('D:/results/CICIoMT2024/history/[CICIoMT2024] [CNN] Binary classification pred.npy',pred)

np.save('D:/results/CICIoMT2024/history/[CICIoMT2024] [CNN] Binary classification Inference time.npy',inference_time_np)
...
plt.savefig('D:/results/CICIoMT2024/figures/[CICIoMT2024] [CNN] Binary classification confusion matrix.eps',  bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
...
# proposed model
mcr.to_csv(r'D:/results/CICIoMT2024/csvs/[CICIoMT2024] [CNN] Binary classification report.csv')
scr.to_csv(r'D:/results/CICIoMT2024/csvs/[CICIoMT2024] [CNN] Summarized binary classification report.csv')
