...
# full dataset
path = r'C:/Users/DELL/Personal use Dropbox/Ahmed Shebl/AhmedShebl/CICIoMT2024/full' # use your path
all_files = glob.glob(path + "/*.csv")
li = []
for filename in all_files:
    df = pd.read_csv(filename,sep=',', encoding='cp1252', index_col=None, header=0)
    li.append(df)
...
data_clean=data_clean.drop('Srate',axis=1)
data_clean=data_clean.drop('Drate',axis=1)
data_clean=data_clean.drop('Magnitue',axis=1)
data_clean=data_clean.drop('Radius',axis=1)
data_clean=data_clean.drop('Covariance',axis=1)
data_clean=data_clean.drop('Weight',axis=1)
data_clean.shape
