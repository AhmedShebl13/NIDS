...
np.save('D:/results/CICIoT2023/History/[CICIoT2023] [CNN] Binary classification history.npy',history.history)

np.save('D:/results/CICIoT2023/History/[CICIoT2023] [CNN] Binary classification Fitting time.npy',fitting_time_np)
...
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [CNN] Binary classification accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0,0.0175)
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [CNN] Binary classification loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
np.save('D:/results/CICIoT2023/history/[CICIoT2023] [CNN] Binary classification pred.npy',pred)

np.save('D:/results/CICIoT2023/history/[CICIoT2023] [CNN] Binary classification Inference time.npy',inference_time_np)
...
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [CNN] Binary classification confusion matrix.eps',  bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
...
# proposed model
mcr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [CNN] Binary classification report.csv')
scr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [CNN] Summarized binary classification report.csv')
