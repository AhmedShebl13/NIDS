...
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [CNN] Multiclass classification confusion matrix.eps',  bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
...
# proposed model
mcr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [CNN] Multiclass classification report.csv')
scr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [CNN] Summarized multiclass classification report.csv')
