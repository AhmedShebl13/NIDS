...
np.save('D:/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification history.npy',history.history)

np.save('D:/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification Fitting time.npy',fitting_time_np)
...
plt.ylim(0.97,1)
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [DNN] Multiclass classification accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0,0.07)
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [DNN] Multiclass classification loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
np.save('D:/results/CICIoT2023/history/[CICIoT2023] [DNN] Multiclass classification pred.npy',pred)

np.save('D:/results/CICIoT2023/history/[CICIoT2023] [DNN] Multiclass classification Inference time.npy',inference_time_np)
...
plt.savefig('D:/results/CICIoT2023/figures/[CICIoT2023] [DNN] Multiclass classification confusion matrix.eps',  bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
...
# proposed model
mcr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [DNN] Multiclass classification report.csv')
scr.to_csv(r'D:/results/CICIoT2023/csvs/[CICIoT2023] [DNN] Summarized multiclass classification report.csv')
