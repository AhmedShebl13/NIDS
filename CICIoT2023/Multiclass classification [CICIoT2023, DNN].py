...
np.save('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification history.npy',history.history)
...
plt.ylim(0.97,1)
plt.savefig('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/figuers/[CICIoT2023] [DNN] Multiclass classification accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0,0.07)
plt.savefig('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/figuers/[CICIoT2023] [DNN] Multiclass classification loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
# np.save('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification y_t.npy',y_t)
# np.save('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification y_p_c.npy',y_p_c)
...
# ax.spines['left'].set_visible(False)
# ax.spines['right'].set_visible(False)
# plt.savefig('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/figuers/[CICIoT2023] [DNN] Multiclass classification roc.eps', format='eps', dpi=1200)
# plt.show()
# plt.clf()
...
plt.savefig('/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/figuers/[CICIoT2023] [DNN] Multiclass classification confusion matrix.eps',  bbox_inches="tight", format='eps', dpi=1200) 
plt.show() 
# plt.figure(figsize = (30,25))
# sn.set(font_scale=2.4)
...
# proposed model
mcr.to_csv(r'/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/csvs/[CICIoT2023] [DNN] Multiclass classification report.csv')
scr.to_csv(r'/Users/ahmad/Library/CloudStorage/Dropbox/Shebl/results/CICIoT2023/csvs/[CICIoT2023] [DNN] Summarized multiclass classification report.csv')
