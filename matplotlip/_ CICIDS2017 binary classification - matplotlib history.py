...
history_cnn = np.load('D:/results/CICIDS-2017/History/[CICIDS2017] [CNN] Binary classification history.npy',allow_pickle='TRUE').item()
history_dnn = np.load('D:/results/CICIDS-2017/History/[CICIDS2017] [DNN] Binary classification history.npy',allow_pickle='TRUE').item()
...
plt.ylim(0.9859,1.0019)
plt.savefig('D:/results/CICIDS-2017/figuers/[CICIDS2017]_Binary_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
plt.savefig('D:/results/CICIDS-2017/figuers/[CICIDS2017]_Binary_classification_loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
