...
history_cnn = np.load('D:/results/CICIDS-2017/History/[CICIDS2017] [CNN] Multiclass classification history.npy',allow_pickle='TRUE').item()
history_dnn = np.load('D:/results/CICIDS-2017/History/[CICIDS2017] [DNN] Multiclass classification history.npy',allow_pickle='TRUE').item()
...
plt.ylim(0.982,1)
plt.savefig('D:/results/CICIDS-2017/figuers/[CICIDS2017]_Multiclass_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(0.00,0.07)
plt.savefig('D:/results/CICIDS-2017/figuers/[CICIDS2017]_Multiclass_classification_loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
