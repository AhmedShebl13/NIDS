...
history_cnn = np.load('D:/results/CICIoMT2024/history/[CICIoMT2024] [CNN] Binary classification history.npy',allow_pickle='TRUE').item()
history_dnn = np.load('D:/results/CICIoMT2024/history/[CICIoMT2024] [DNN] Binary classification history.npy',allow_pickle='TRUE').item()
...
plt.ylim(0.9969,1)
plt.savefig('D:/results/CICIoMT2024/figures/[CICIoMT2024]_Binary_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['left'].set_visible(False)
ax.spines['right'].set_visible(False)
plt.ylim(-0.001,0.0085)
plt.savefig('D:/results/CICIoMT2024/figures/[CICIoMT2024]_Binary_classification_loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
