...
history_cnn = np.load('D:/results/CICIoT2023/History/[CICIoT2023] [CNN] Binary classification history.npy',allow_pickle='TRUE').item()
history_dnn = np.load('D:/results/CICIoT2023/History/[CICIoT2023] [DNN] Binary classification history.npy',allow_pickle='TRUE').item()
...
plt.ylim(0.9920,0.9955)
plt.savefig('D:/results/CICIoT2023/figuers/[CICIoT2023]_Binary_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
plt.savefig('D:/results/CICIoT2023/figuers/[CICIoT2023]_Binary_classification_loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
