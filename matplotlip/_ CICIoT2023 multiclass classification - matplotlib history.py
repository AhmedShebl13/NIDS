...
history_cnn = np.load('D:/results/CICIoT2023/History/[CICIoT2023] [CNN] Multiclass classification history.npy',allow_pickle='TRUE').item()
history_dnn = np.load('D:/results/CICIoT2023/History/[CICIoT2023] [DNN] Multiclass classification history.npy',allow_pickle='TRUE').item()
...
plt.ylim(0.929,1)
plt.savefig('D:/results/CICIoT2023/figuers/[CICIoT2023]_Multiclass_classification_accuracy.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
...
ax.spines['right'].set_visible(False)
plt.ylim(-0.002,0.18)
plt.savefig('D:/results/CICIoT2023/figuers/[CICIoT2023]_Multiclass_classification_loss.eps', format='eps', dpi=1200)
plt.show()
plt.clf()
